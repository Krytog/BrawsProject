...
//        std::vector<std::pair<std::string_view, VisibleObject*>> decoy_vector;
        auto officer_animation = new AnimatedSprite(new Position(pos), 100, 100, "../Game/DEMOs/v0.3/Resources/ZZZ.png", LEVELS::FIRST_USER_LEVEL, 4, 2, 3, {}, true);
...
//        decoy_vector.emplace_back(SHEET, blow_animation);
        ...
        engine_->ProduceObject<Krip>(new Position(pos),
                                     new RectangleCollider(Position(pos), 100, 100),
                                     officer_animation,
                                     "officer", CharacterInitArgPack{}, speed_, &deaths_counter_, obj_to_follow_);
    }
