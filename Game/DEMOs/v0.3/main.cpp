...
int main() {
    ...
    auto aim = engine.ProduceObject<Cursor>(
        new Position(0, 0), new CircleCollider(Position(0, 0), 40, true),
        new StaticSprite(new Position(0, 0), 60, 50, "../Game/DEMOs/v0.3/Resources/aim.png",
                         LEVELS::SECOND_USER_LEVEL),
        "aim");
    engine.ProduceObject<GameObject>(
        new Position(0, 0), nullptr,
        new StaticSprite(new Position(0, 0), 2000, 1000, "../Game/DEMOs/v0.3/Resources/background.jpg",
    ...
    VisibleObject* run_left =
        new AnimatedSprite(new Position(0, 0), 200, 250, arg_pack.run_left_animation_path,
                           LEVELS::FIRST_USER_LEVEL, 10, 18, 1, {0}, true);
    VisibleObject* run_right =
        new AnimatedSprite(new Position(0, 0), 200, 250, arg_pack.run_right_animation_path,
                           LEVELS::FIRST_USER_LEVEL, 10, 18, 1, {0}, true);
    VisibleObject* death = new AnimatedSprite(new Position(0, 0), 200, 250, arg_pack.death_animation_path,
                                              LEVELS::FIRST_USER_LEVEL, 10, 18, 1, {0}, false);
    ...
    auto player = engine.ProduceObject<Zelensky>(
        new Position(0, 0), new RectangleCollider(Position(0, 0), 200, 250),
        // run_left,
        new AnimationSequencer(decoy_vector, interrupt_points, true), "Zelensky_player", arg_pack, aim, 20);
